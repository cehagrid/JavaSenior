 ...
 *
 * 4.可以通过相关操作，实现RandomAccessFile“插入”数据的操作效果
 * @author llystart
 * @create 2023-01-28-22:00
 */
public class RandomAccessFileTest {
    ...
    public void test1() {
        ...
        try {
            raf1 = new RandomAccessFile(new File("day.jpg"), "r");
            raf2 = new RandomAccessFile(new File("day1.jpg"), "rw");
