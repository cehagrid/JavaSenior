...
public class ReflectionTest {
    ...
    public void test3() throws ClassNotFoundException {
        ...
        //方式2通过运行时类的对象,调用getClass()
        Person p1 = new Person();
        Class clazz2 = p1.getClass();
        System.out.println(clazz2);

        //方式三：调用Class发静态方法：forName(String classPath)（最多使用）
        Class clazz3 = Class.forName("com.atguigu.java.Person");//可以在运行时才知道有没有错，体现运行时
    ...
    //万事万物接对象？对象.xxx,File,URL,反射,前端、数据库操作
